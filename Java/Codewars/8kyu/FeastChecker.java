...
public class Kata {
    ...
    public static boolean feast(String beast, String dish) {
        return String.valueOf(beast.toCharArray()[0]).equals(String.valueOf(dish.toCharArray()[0])) &&
                (String.valueOf(beast.toCharArray()[beast.length() - 1]).equals(String.valueOf(dish.toCharArray()[dish.length() - 1])));
    }
}
